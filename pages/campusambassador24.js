    ...
    return (
        <div style={{ background: '#1C1D47' }}>
            <Head>
                ...
                <meta
                    name="description"
                    content="CampusAmbassador-Anwesha 2024"
                />
            ...
            <div className={styles.registerposition}>
                <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSdibq4yc8kvo91fNSDh0ZzhDFrmi3f_umAtgnrxrqjAXiJ7fA/viewform"
            ...
            <div className={styles.turtlediv}>
                ...
                <div className={styles.perks}>
                    ...
                    <ul className={styles.perkcontent}>
                        ...
                        <li>
                            • Feature of Top 3 CAs on Anwesha Social
                            &nbsp;&nbsp;Media
                        </li>
                    </ul>
                </div>
            ...
            <div className={styles.mandiv}>
                <div className={styles.perks} style={{ marginTop: '11vw' }}>
                    ...
                    <ul className={styles.perkcontent}>
                        ...
                        <li>
                            • Increase the registration from the
                            &nbsp;&nbsp;college
                        </li>
            ...
            <div className={styles.judgebox}>
                ...
                <div>
                    ...
                    <div className={styles.judgecontent}>
                        <p className={styles.leftbox}>Online Registration</p>
                        <p className={styles.rightbox}>15xp</p>
                    </div>

                    <div className={styles.judgecontent}>
                        <p
                            className={styles.leftbox}
                            style={{ background: '#51295E' }}
                        >
                    ...
                    <div className={styles.judgecontent}>
                        <p className={styles.leftbox}>Instagram Story</p>
                        <p className={styles.rightbox}>5xp</p>
                    </div>
                    ...
                    <div className={styles.judgecontent}>
                        <p className={styles.leftbox}>Putting Poster/Banner</p>
                        <p className={styles.rightbox}>15xp</p>
                    </div>
                    ...
                    <div className={styles.judgecontent}>
                        <p className={styles.leftbox}>Hospitality</p>
                        <p className={styles.rightbox}>10-30xp</p>
                    </div>
                </div>
            </div>
